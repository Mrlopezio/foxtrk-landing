        ...
        <div className={styles.frame7}>
          ...
          <div className={styles.frame3}>
            <div className={styles.frame4}>
              <img
                className={styles.lucideGauge}
                src="/media/mileage-tracking.svg"
              />
            ...
            <div className={styles.frame5}>
              <img
                className={styles.lucideCoins}
                src="/media/expense-logging.svg"
              />
            ...
            <div className={styles.frame6}>
              <img
                className={styles.lucideWrench}
                src="/media/maintenance-costs.svg"
              />

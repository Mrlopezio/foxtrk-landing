        ...
        <div className={styles.frame7}>
          ...
          <div className={styles.frame3}>
            <div className={styles.frame4}>
              <img className={styles.lucideGauge} src="../../public/media/mileage-tracking.svg" />
            ...
            <div className={styles.frame5}>
              <img className={styles.lucideCoins} src="../../public/media/expense-logging.svg" />
            ...
            <div className={styles.frame6}>
              <img className={styles.lucideWrench} src="../../public/media/maintenance-costs.svg" />

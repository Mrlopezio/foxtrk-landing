        ...
        <div className={styles.frame7}>
          ...
          <div className={styles.frame3}>
            <div className={styles.frame4}>
              <img className={styles.lucideGauge} src="lucide-gauge0.svg" />
            ...
            <div className={styles.frame5}>
              <img className={styles.lucideCoins} src="lucide-coins0.svg" />
            ...
            <div className={styles.frame6}>
              <img className={styles.lucideWrench} src="lucide-wrench0.svg" />
